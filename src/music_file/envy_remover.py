...
# Example Usage
def remove_substring_from_nfo(file_path, substring):
...
def process_nfo_files(directory_path, substring):
    for root, dirs, files in os.walk(directory_path):
        for file_name in files:
            ...
            if file_name.lower().endswith('.nfo'):
                remove_substring_from_nfo(file_path, substring)
...
# Example Usage
directory_path = r"M:\Music\Music\Jatin-Lalit\Dilwale Dulhania Le Jayenge (1995)"
substring_to_remove = " - EnVy"
process_nfo_files(directory_path, substring_to_remove)
